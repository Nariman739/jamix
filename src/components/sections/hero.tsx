...
const chatPreview = [
  { role: "user", text: "Привет, у меня салон красоты. Клиенты забывают про запись" },
  { role: "bot", text: "О, знакомая проблема! А сколько примерно записей в день теряется?" },
  { role: "user", text: "Штук 5-7 в неделю точно. И администратор полдня в телефоне" },
  { role: "bot", text: "Представьте: клиент пишет в WhatsApp, бот сам записывает и за 2 часа напоминает. Администратор свободен. Хотите обсудим под ваш салон?" },
];
